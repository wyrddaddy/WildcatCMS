...
<link rel="stylesheet" type="text/css" href="/css/scrollbars/scrollbars.css" />
<!--<link rel="stylesheet" type="text/css" href="css/scrollbars-itunes.css" />-->
<link rel="stylesheet" type="text/css" href="/css/scrollbars/scrollbars-black.css" />
<!-- Move to Dynamic Later -->
<link rel="stylesheet" type="text/css" href="/css/slider-banners/multi-content-slider.css?v3"/>
<?php 
...
<script src="/js/base.js?v7" type="text/javascript"></script>
...
<body>
    ...
    <!-- Main Wrapper to Set Site Alignment -->
        <div class="container_<?php echo $layoutSize[0]; ?>"> 
            <!-- Body Content -->
                <!-- Header Content -->
                    <?php  include(SERVER_ROOT . 'includes/header/header.php'); ?>
                <!-- End Body Content -->
                    <?php
